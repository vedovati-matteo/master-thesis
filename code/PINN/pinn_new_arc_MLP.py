...
from .models import NewArchNN

def pin_new_arc_MLP_exe(net_size, lr, batch_size, ode, stopping_loss, device, max_iter=50_000, wd=None):
    ...
    model = NewArchNN(1, num_layers, num_neurons, dim).to(device)
